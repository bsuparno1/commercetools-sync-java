...
public final class ProductSyncUtils {
   ...
   * com.commercetools.sync.products.ProductSyncOptions, Map)}) of a {@link ProductProjection} and a
   * {@link ProductDraft}, given that each of these fields pass the specified {@link
   * com.commercetools.sync.products.SyncFilter}. It returns a {@link List} of {@link
   * ProductUpdateAction}&lt;{@link Product}&gt; as a result. If no update action is needed, for
   ...
   * the {@link com.commercetools.sync.products.ProductSyncOptions} instance on the resultant list
